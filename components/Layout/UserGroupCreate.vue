    ...
    <template v-slot:prepend>
      <div class="group-detail__header-tab white">
        ...
        >
          ...
          {{ sysLanguage.title.createGroupTitle }}
        </p>
...
export default {
  ...
  methods: {
    ...
    async onCreate() {
      ...
      const res = await api.userGroup.create(body)
      this.loadingBtn = false
      if (!res) {
        this.$store.commit(
          "toast/getError",
          this.sysLanguage.snackbar.createUserGroupFail,
        )
        return
      }
      try {
        ...
        this.$store.commit(
          "toast/getSuccess",
          this.sysLanguage.snackbar.createUserGroupSuccess,
        )
